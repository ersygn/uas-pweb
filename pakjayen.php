    ...
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="pakjayen.php" style="color: yellow;">
                    <i class="fas fa-fw fa-users" style="color: yellow;"></i>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Customer Tahu Telor Pak Jayen</h1>
                    </div>
                    <div class="row">
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                    ...
                                                    $sql = "SELECT COUNT(customer_id) AS tocus FROM pesanan WHERE nama_resto = '$nama_resto'"; 
                                                    $query = mysqli_query($mysqli, $sql);
                                                    while ($row2 = mysqli_fetch_array($query)) {
                                                        echo number_format($row2['tocus'], 0, ".", ",");
                                                    }
                                                ?>
                                                </div>
                                        </div>
            ...
            <div class="form-row">
                <div class="col-12" style="text-align: right; margin-bottom: 20px;">
                    <a href="cetakpdfpj.php" class= "btn btn-danger">Cetak Data PDF</a>
                    <a href="cetakexcelpj.php" class= "btn btn-success">Cetak Data Excel</a>
                </div>
            </div>
              ...
              <div class="form-row">
                <div class="col-12">
                    <center><table border="1" style="margin-bottom: 20px;">
                        ...
                        $pesanan = mysqli_query($con, "SELECT * from pesanan WHERE nama_resto = '$nama_resto'");
                        $no=1;
