    ...
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="burudy.php" style="color: yellow;">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Customer Bu Rudy</h1>
                    </div>
                    <div class="row">
            ...
            <div class="form-row">
                <div class="col-12" style="text-align: right; margin-bottom: 20px;">
                    <a href="cetakpdfbr.php" class= "btn btn-danger">Cetak Data PDF</a>
                    <a href="cetakexcelbr.php" class= "btn btn-success">Cetak Data Excel</a>
                </div>
            </div>
